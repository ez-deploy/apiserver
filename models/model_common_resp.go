...
func (m *ModelCommonResp) validateError(formats strfmt.Registry) error {
...
func (m *ModelCommonResp) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
