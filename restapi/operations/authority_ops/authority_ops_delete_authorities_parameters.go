...
func NewAuthorityOpsDeleteAuthoritiesParams() AuthorityOpsDeleteAuthoritiesParams {
	...
	return AuthorityOpsDeleteAuthoritiesParams{}
}

// AuthorityOpsDeleteAuthoritiesParams contains all the bound params for the authority ops delete authorities operation
...
func (o *AuthorityOpsDeleteAuthoritiesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
