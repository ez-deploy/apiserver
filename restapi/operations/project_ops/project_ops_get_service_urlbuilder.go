...
func (o *ProjectOpsGetServiceURL) WithBasePath(bp string) *ProjectOpsGetServiceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ProjectOpsGetServiceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ProjectOpsGetServiceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ProjectOpsGetServiceURL")
	}
