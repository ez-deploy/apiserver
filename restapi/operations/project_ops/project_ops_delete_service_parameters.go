...
func NewProjectOpsDeleteServiceParams() ProjectOpsDeleteServiceParams {
	...
	return ProjectOpsDeleteServiceParams{}
}

// ProjectOpsDeleteServiceParams contains all the bound params for the project ops delete service operation
...
func (o *ProjectOpsDeleteServiceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ProjectOpsDeleteServiceParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ProjectOpsDeleteServiceParams) bindServiceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
