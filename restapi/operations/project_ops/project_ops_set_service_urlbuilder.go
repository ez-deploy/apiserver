...
func (o *ProjectOpsSetServiceURL) WithBasePath(bp string) *ProjectOpsSetServiceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ProjectOpsSetServiceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ProjectOpsSetServiceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ProjectOpsSetServiceURL")
	}
