...
func NewProjectOpsListServiceParams() ProjectOpsListServiceParams {
	...
	return ProjectOpsListServiceParams{}
}

// ProjectOpsListServiceParams contains all the bound params for the project ops list service operation
...
func (o *ProjectOpsListServiceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ProjectOpsListServiceParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
