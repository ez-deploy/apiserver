...
func (o *ProjectOpsDeleteProjectURL) WithBasePath(bp string) *ProjectOpsDeleteProjectURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ProjectOpsDeleteProjectURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ProjectOpsDeleteProjectURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ProjectOpsDeleteProjectURL")
	}
