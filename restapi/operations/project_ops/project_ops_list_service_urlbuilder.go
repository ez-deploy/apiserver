...
func (o *ProjectOpsListServiceURL) WithBasePath(bp string) *ProjectOpsListServiceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ProjectOpsListServiceURL) Build() (*url.URL, error) {
	...
	var _path = "/project/service/list"
...
func (o *ProjectOpsListServiceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ProjectOpsListServiceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ProjectOpsListServiceURL")
	}
