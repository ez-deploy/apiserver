...
func NewProjectOpsSetServiceParams() ProjectOpsSetServiceParams {
	...
	return ProjectOpsSetServiceParams{}
}

// ProjectOpsSetServiceParams contains all the bound params for the project ops set service operation
...
func (o *ProjectOpsSetServiceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ProjectSetServiceReq
