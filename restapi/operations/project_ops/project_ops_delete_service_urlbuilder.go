...
func (o *ProjectOpsDeleteServiceURL) WithBasePath(bp string) *ProjectOpsDeleteServiceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ProjectOpsDeleteServiceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ProjectOpsDeleteServiceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ProjectOpsDeleteServiceURL")
	}
