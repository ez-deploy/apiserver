...
func NewProjectOpsGetServiceParams() ProjectOpsGetServiceParams {
	...
	return ProjectOpsGetServiceParams{}
}

// ProjectOpsGetServiceParams contains all the bound params for the project ops get service operation
...
func (o *ProjectOpsGetServiceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ProjectOpsGetServiceParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ProjectOpsGetServiceParams) bindServiceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
