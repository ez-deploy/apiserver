...
func NewIdentityOpsGeneratePublicTokenParams() IdentityOpsGeneratePublicTokenParams {
	...
	return IdentityOpsGeneratePublicTokenParams{}
}

// IdentityOpsGeneratePublicTokenParams contains all the bound params for the identity ops generate public token operation
...
func (o *IdentityOpsGeneratePublicTokenParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IdentityGeneratePublicTokenReq
