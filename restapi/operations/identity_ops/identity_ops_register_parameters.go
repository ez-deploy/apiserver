...
func NewIdentityOpsRegisterParams() IdentityOpsRegisterParams {
	...
	return IdentityOpsRegisterParams{}
}

// IdentityOpsRegisterParams contains all the bound params for the identity ops register operation
...
func (o *IdentityOpsRegisterParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IdentityRegisterReq
