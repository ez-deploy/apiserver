...
func (o *IdentityOpsGetPrivateTokenURL) WithBasePath(bp string) *IdentityOpsGetPrivateTokenURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *IdentityOpsGetPrivateTokenURL) String() string {
...
func (o *IdentityOpsGetPrivateTokenURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IdentityOpsGetPrivateTokenURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IdentityOpsGetPrivateTokenURL")
	}
