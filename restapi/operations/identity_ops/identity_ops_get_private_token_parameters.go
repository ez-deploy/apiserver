...
func NewIdentityOpsGetPrivateTokenParams() IdentityOpsGetPrivateTokenParams {
	...
	return IdentityOpsGetPrivateTokenParams{}
}

// IdentityOpsGetPrivateTokenParams contains all the bound params for the identity ops get private token operation
...
func (o *IdentityOpsGetPrivateTokenParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IdentityOpsGetPrivateTokenParams) bindEmail(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *IdentityOpsGetPrivateTokenParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
