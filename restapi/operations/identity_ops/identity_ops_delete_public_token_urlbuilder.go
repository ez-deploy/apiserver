...
func (o *IdentityOpsDeletePublicTokenURL) WithBasePath(bp string) *IdentityOpsDeletePublicTokenURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *IdentityOpsDeletePublicTokenURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *IdentityOpsDeletePublicTokenURL) String() string {
...
func (o *IdentityOpsDeletePublicTokenURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IdentityOpsDeletePublicTokenURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IdentityOpsDeletePublicTokenURL")
	}
