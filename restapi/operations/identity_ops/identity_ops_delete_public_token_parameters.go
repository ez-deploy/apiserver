...
func NewIdentityOpsDeletePublicTokenParams() IdentityOpsDeletePublicTokenParams {
	...
	return IdentityOpsDeletePublicTokenParams{}
}

// IdentityOpsDeletePublicTokenParams contains all the bound params for the identity ops delete public token operation
...
func (o *IdentityOpsDeletePublicTokenParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IdentityDeletePublicTokenReq
