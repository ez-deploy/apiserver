...
func NewIdentityOpsLoginParams() IdentityOpsLoginParams {
	...
	return IdentityOpsLoginParams{}
}

// IdentityOpsLoginParams contains all the bound params for the identity ops login operation
...
func (o *IdentityOpsLoginParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IdentityLoginReq
