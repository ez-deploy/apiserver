...
func (o *IdentityOpsRegisterURL) WithBasePath(bp string) *IdentityOpsRegisterURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *IdentityOpsRegisterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IdentityOpsRegisterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IdentityOpsRegisterURL")
	}
