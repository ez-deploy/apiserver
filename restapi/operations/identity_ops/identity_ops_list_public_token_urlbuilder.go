...
func (o *IdentityOpsListPublicTokenURL) WithBasePath(bp string) *IdentityOpsListPublicTokenURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *IdentityOpsListPublicTokenURL) String() string {
...
func (o *IdentityOpsListPublicTokenURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IdentityOpsListPublicTokenURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IdentityOpsListPublicTokenURL")
	}
