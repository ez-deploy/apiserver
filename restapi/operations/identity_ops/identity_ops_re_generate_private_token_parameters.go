...
func NewIdentityOpsReGeneratePrivateTokenParams() IdentityOpsReGeneratePrivateTokenParams {
	...
	return IdentityOpsReGeneratePrivateTokenParams{}
}

// IdentityOpsReGeneratePrivateTokenParams contains all the bound params for the identity ops re generate private token operation
...
func (o *IdentityOpsReGeneratePrivateTokenParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
